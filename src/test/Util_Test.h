...
namespace pgen
{
	...
	public:
		...
		void test_hex2int() 
		{
			CPPUNIT_ASSERT( Util::hex2int(0x10) == 0 );
			CPPUNIT_ASSERT( Util::hex2int(0x29) == 0 );
			CPPUNIT_ASSERT( Util::hex2int(0x30) == 0 );
			CPPUNIT_ASSERT( Util::hex2int(0x31) == 1 );
			CPPUNIT_ASSERT( Util::hex2int(0x32) == 2 );
			CPPUNIT_ASSERT( Util::hex2int(0x33) == 3 );
			CPPUNIT_ASSERT( Util::hex2int(0x34) == 4 );
			CPPUNIT_ASSERT( Util::hex2int(0x35) == 5 );
			CPPUNIT_ASSERT( Util::hex2int(0x36) == 6 );
			CPPUNIT_ASSERT( Util::hex2int(0x37) == 7 );
			CPPUNIT_ASSERT( Util::hex2int(0x38) == 8 );
			CPPUNIT_ASSERT( Util::hex2int(0x39) == 9 );
			CPPUNIT_ASSERT( Util::hex2int(0x3A) == 0 );
			CPPUNIT_ASSERT( Util::hex2int(0x3B) == 0 );
			CPPUNIT_ASSERT( Util::hex2int('A') == 10);
			CPPUNIT_ASSERT( Util::hex2int('B') == 11);
			CPPUNIT_ASSERT( Util::hex2int('C') == 12);
			CPPUNIT_ASSERT( Util::hex2int('D') == 13);
			CPPUNIT_ASSERT( Util::hex2int('E') == 14);
			CPPUNIT_ASSERT( Util::hex2int('F') == 15);
			CPPUNIT_ASSERT( Util::hex2int('G') == 0);
			CPPUNIT_ASSERT( Util::hex2int(' ') == 0);
			CPPUNIT_ASSERT( Util::hex2int('!') == 0);
			CPPUNIT_ASSERT( Util::hex2int('@') == 0);
			CPPUNIT_ASSERT( Util::hex2int('a') == 10);
			CPPUNIT_ASSERT( Util::hex2int('b') == 11);
